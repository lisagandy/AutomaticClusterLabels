...
if __name__ == '__main__': 
    ...
    # lsMatrix = [[1],[1,2],[1,2,3]]
    # dg = DoGrouping()
    
    # lb1 = LabelClass('stuff','spreadsheet1')
    # lb2 = LabelClass('stuff2','spreadsheet2')
    # lb3 = LabelClass('stuff3','spreadsheet1')
    
    # lsTest = [lb1,lb2]
    # lsTest2 = [lb2,lb3]
    
    #dg = DoGrouping()
    # print dg.okayGroup(lsTest,lsTest2)
    # assert 0
    # dAll = {"label1":[["label3",0.9],["label2",1.0]],"label5":[["label1",0.8],["label4",0.6]],"label6":[["label2",0.4]]}
    #dg.doGrouping(dAll)
    #dAllCombos = dg.getAllScores()  
    # print dAllCombos
    #pickle.dump(dAllCombos,open("/Users/lisa/Desktop/save.p","wb"))
    # assert 0                  
    #dAllCombos = pickle.load(open('/Users/lisa/Desktop/save.p','rb'))
    
    #lsMerged,lsAlone = dg.doGrouping(dAllCombos)
    #pickle.dump([lsMerged,lsAlone],open('/Users/lisa/Desktop/jordan_objects.p','wb'))
    #assert 0
    #for labelC in lsMerged:
        #for label in lsLabel:
            #print labelC.strOrigText
            #print labelC.mergedText
            # print label.strTextAfterChanges
            #             print "-----"
            #             print label.lsOrigColumnValuesSet
            #             print label.dCollocates
            #             print label.dCollocatesOther
            #             print label.strType
            #print "DONE"
    #dg.makeSpreadsheet(lsMerged, lsAlone)
